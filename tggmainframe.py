...
def tgg_mainframe():
    ...
    def skill_challenge_page():
        ...
        def heal_challenge_page(healer, injured):

            healer_variable = StringVar()
            healer_variable.set("Choose a Healer")

            injured_variable = StringVar()
            injured_variable.set("Choose an injured PC")
        ...
        pc_dropdown = OptionMenu(sc_frame, cvariable, "Ho", "Kinzin", "Mignon", "Raven", "Sev", "Vampyrate")
